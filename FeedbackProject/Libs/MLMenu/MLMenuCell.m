...
- (void)layoutSubviews
{
    ...
    titleCenterX = self.imageViewAccessory.hidden?(self.frame.size.width - 10 - 10) * 0.5  + 10:(self.frame.size.width -self.imageViewAccessory.bounds.size.width - 10 - 10 - 10) * 0.5 + 15 + self.imageViewAccessory.bounds.size.width + 10;
...
- (void)setMenuItem:(MLMenuItem *)menuItem
{
    ...
    self.viewLine.backgroundColor = menuItem.separatorColor ?  menuItem.separatorColor :[UIColor whiteColor];
